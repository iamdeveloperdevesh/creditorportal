                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter Partner Name" id="creaditor_name" name="creaditor_name" type="text" value="<?php if(!empty($getDetails[0]['creaditor_name'])){echo $getDetails[0]['creaditor_name'];}?>" aria-describedby="inputGroupPrepend" />
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter Partner Code" id="creditor_code" name="creditor_code" type="text" value="<?php if(!empty($getDetails[0]['creditor_code'])){echo $getDetails[0]['creditor_code'];}?>" aria-describedby="inputGroupPrepend" />
                                <div class="input-group-prepend">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter Partner Email" id="ceditor_email" name="ceditor_email" type="text" value="<?php if(!empty($getDetails[0]['ceditor_email'])){echo $getDetails[0]['ceditor_email'];}?>" aria-describedby="inputGroupPrepend" />
                                <div class="input-group-prepend">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                         <input class="form-control" placeholder="Enter Partner Mobile" id="creditor_mobile" name="creditor_mobile" maxlength="10" pattern="\d*"  type="tel" value="<?php if(!empty($getDetails[0]['creditor_mobile'])){echo $getDetails[0]['creditor_mobile'];}?>" maxlength="10" aria-describedby="inputGroupPrepend" />
                                <div class="input-group-prepend">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter Partner Phone" id="creditor_phone" maxlength="10" pattern="\d*" name="creditor_phone" type="tel" value="<?php if(!empty($getDetails[0]['creditor_phone'])){echo $getDetails[0]['creditor_phone'];}?>" aria-describedby="inputGroupPrepend" maxlength="10" />
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">stay_current_portrait</span></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter PAN" id="creditor_pancard" name="creditor_pancard" type="text" value="<?php if(!empty($getDetails[0]['creditor_pancard'])){echo $getDetails[0]['creditor_pancard'];}?>" aria-describedby="inputGroupPrepend" maxlength="10"/>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter GST Number" id="creditor_gstn" name="creditor_gstn" type="text" value="<?php if(!empty($getDetails[0]['creditor_gstn'])){echo $getDetails[0]['creditor_gstn'];}?>" aria-describedby="inputGroupPrepend" maxlength="15"/>
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">contact_mail</span></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter CD Balance" id="cd_balance" name="cd_balance" type="text" value="<?php if(!empty($getDetails[0]['initial_cd'])){echo $getDetails[0]['initial_cd'];}?>" aria-describedby="inputGroupPrepend" />
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">contact_mail</span></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter Threshold" id="threshold" min="0.1" name="threshold" type="text" value="<?php if(!empty($getDetails[0]['cd_threshold'])){echo $getDetails[0]['cd_threshold'];}?>" aria-describedby="inputGroupPrepend" />
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">contact_mail</span></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <textarea class="form-control"  placeholder="Enter Address"  name="address" id="address"><?php if(!empty($getDetails[0]['address'])){echo $getDetails[0]['address'];}?></textarea>
                                <div class="input-group-prepend">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input class="form-control" minlength="2" maxlength="3" onkeydown="return /[a-z]/i.test(event.key)" placeholder="Enter Short Code" id="short_code" name="short_code" type="text" value="<?php if(!empty($getDetails[0]['short_code'])){echo $getDetails[0]['short_code'];}?>" aria-describedby="inputGroupPrepend" />
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">account_circle</span></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" placeholder="Enter Term & condition Text" name="tc_text" id="tc_text"><?php if(!empty($getDetails[0]['term_condition'])){echo $getDetails[0]['term_condition'];}?></textarea>
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">contact_mail</span></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            ?>
                                <input id="negative_issuance" <?php echo $checked; ?> class="mt-1" name="negative_issuance" type="checkbox" value="1" aria-describedby="inputGroupPrepend" />
