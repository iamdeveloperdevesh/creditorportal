...
<style>
    ...
    #editdetails-float .modal-dialog .modal-content{
        background: #fff;
    }
    .borderBottm{
    ...
    #editdetails-float .modal-footer{
        margin-top: 0px;
    }
    .editDetil_Formbody{
        border-radius: 17px;
    ...
    .login-card {
        box-shadow: 0px 10px 40px 0px rgba(8,8,8,0.15);
        border-radius: 36px;
        padding-bottom: 14px;
    ...
    .header-pre {
        ...
        /* margin-right: 10px;*/
        text-align: right;
        box-shadow: 0px 0px 16px 0px rgba(8,8,0,0.15);
...
.card.login-card .card-body {
    padding: 1.6rem 1.6rem 1px 1.6rem;
}
...
<?php 
$dobs = array_filter($quote_info['member_ages'], function($a) { return !is_null($a['dob']); }) ;
$modalonload = 0;
if(empty($dobs)){
    $modalonload = 1;
}
...
foreach($quote_info['policy_details'] as $policy_val)
{
    ...
    //if (($policy_val['is_combo'] == 1 && $policy_val['is_optional'] == 0) ||($policy_val['is_combo'] == 1 && $policy_val['is_optional'] == 1) || ($policy_val['is_combo'] == 0 &&  $policy_val['is_optional'] == 0)) {
    // $exist = 1;
...
foreach ($quote_info['mandatory_if_not_selected'] as $key=>$man_policy){
  //print_r($man_policy);die;
  foreach ($man_policy as $mp){
      $mandatory_array[$key][]=$mp['dependent_on_policy_id'];
  }

}

$policy_id_imp = implode(',',$policy_with_premium);
//var_dump($policy_id_imp);exit;
$data = [];
...
if($quote_info['lead_details']['is_mailer_api']==1){
    rsort($resl);
}

$total_sumInsuredCount=count($quote_info['policy_details']);
...
<div class="main-content-inner" style="min-height: calc(96vh - 100px);">
    <div class="container">
        <div class="row mt-2">
            <div class="col-lg-7 offset-lg-1 col-md-12 mt-2 mb-2">
                <div class="card login-card mb-3">
                    <div class="card-body" style="margin-bottom:48px !important;">
                        ...
                        <div class="generate-body">
                            ...
                            <div class="cover-tab " style="margin-top:2rem !important;">
                                <div class="tab-part">
...
<!--                                <p class="lbl-cover mt-2 mb-2">Selected Product</p>-->
                                                ...
                                                <div class="card box-gen ">
                                                    <div class="card-body">
                                                        <div class="head-del">
                                                            ...
                                                            <?php
                                                            if($total_sumInsuredCount == 1){}else{ ?>
                                                            ...
                                                            <div class="body-product-del mt-4 mb-3">
                                                                ...
                                                                $arr_fam = [];
                                                                $arr_members = [];
                                                                foreach($quote_info['member_ages'] as $key => $family_con){

                                                                    array_push($arr_fam,$family_con['member_type']);

                                                                    $arr_members[$family_con['member_name']]['dob'] = $family_con['dob'];
                                                                    $arr_members[$family_con['member_name']]['member_id'] = $family_con['member_type'];
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        if(!empty($quote_info['deductable'])){ ?>
                                                                            <p class="sum-del mt-4" style="display:flex">
                                                                            <span class="col-md-6 sum-delNew">
                                                                             Sum Insured<br>
                                                                        ...
                                                                        <span class="col-md-6" style="border-left:1px dashed #107591">
                                                                            Deductible<br>
                                                                            <?php foreach($quote_info['policy_details'] as $val_quote){
                                                                                $sum_club = $val_quote['self']['sub_type_name']." - ".$val_quote['self']['cover'];

                                                                                ?>
                                                                                <span class="amt-del deductable_new"><?php echo $quote_info['deductable'];?><br/></span>
                                                                        ...
                                                                        <?php }else{?>
                                                                            <p class="sum-del sum-delNew mt-4">
                                                                            Sum Insured<br>
                                                                            <?php foreach($quote_info['policy_details'] as $val_quote){
                                                                                $sum_club = $val_quote['self']['sub_type_name']." - ".$val_quote['self']['cover'];
                                                                ...
                                                                <div class="familyonstruct_div">
                                                                    <p class="ml-tittle">Select Family Construct  <span class="ed-nme fl-left" data-toggle="modal" data-backdrop="static" data-target="#editdetails-member"> <i class="fa fa-pencil"></i></span>
                                                                    ...
                                                                    <div class="row family_flot_construct">
                                                                        ...
                                                                        if(1==1 ){
                                                                             ...
                                                                             $sel_con_count = array_count_values($arr_fam);
                                                                        $son_count = !empty($sel_con_count['Son'])?$sel_con_count['Son']:0;
                                                                        $daughter_count = !empty($sel_con_count['Daughter'])?$sel_con_count['Daughter']:0;
                                                                        $total_kids = $daughter_count+$son_count;
                                                                        $i =1;
                                                                     //   print_r($arr_fam);
                                                                        //                var_dump($arr_fam);
                                                                         $j=1;
                                                                        foreach($quote_info['get_family_construct_data']['adult'] as $fam_con){
                                                                            ...
                                                                            if($fam_con['is_adult'] == 'Y' )
                                                                            {
                                                                                ...
                                                                                if(in_array($fam_con['member_type'],$arr_fam)){ ?>
                                                                                    <div class="custom-control custom-checkbox"><input type="checkbox" disabled="true" name="family_construct_arr[]" class="custom-control-input" data-kid = "<?php   echo $fam_con['is_adult'];?>"data-id="<?php echo $fam_con['id'];?>" id="customfrid1<?php echo $fam_con['id'];?>" checked value = "<?php echo $fam_con['member_type'];?>" ><label class="custom-control-label" for="customfrid1<?php echo $fam_con['id'];?>"><span><?php echo $fam_con['member_type'];?></span></label></div>
                                                                                <?php }else{?>
                                                                                    <div class="custom-control custom-checkbox"><input type="checkbox"  disabled="true" name="family_construct_arr[]" class="custom-control-input"  data-kid = "<?php   echo $fam_con['is_adult'];?>"data-id="<?php echo $fam_con['id'];?>" id="customfrid1<?php echo $fam_con['id'];?>" value = "<?php echo $fam_con['member_type'];?>"><label class="custom-control-label" for="customfrid1<?php echo $fam_con['id'];?>"><span><?php echo $fam_con['member_type'];?></span></label></div>
                                                                                <?php }
                                                                                ?>
                                                                        ...
                                                                        for($i=1;$i<=$child_count_det;$i++)
                                                                        {
                                                                            ...
                                                                            if($i<=$total_kids){
                                                                                $chked = 'checked';
                                                                             $member_id = $arr_members[$member_type]['member_id'];

                                                                            }
                                                                            ?>
                                                                            <div class="col-md-6 col-6">
                                                                                
                                                                                    <div class="custom-control custom-checkbox"><input type="checkbox"  disabled="true" name="family_construct_arr[]"  <?php echo $chked;?> class="custom-control-input" data-kid = "N" data-id="<?php echo $member_type;?>" id="customfrid1_<?php echo $member_type;?>" value = "<?php echo  $member_type;?>"><label class="custom-control-label" for="customfrid1_<?php echo $member_type;?>"><span><?php echo (!empty($member_id)) ? $member_id : $member_type;?></span></label></div>
                                                                        ...
                                                                        //echo '<pre>';print_r($quote_info['get_family_construct_data']['adult']);exit;  

                                                                        $newArr = array_combine(array_column($quote_info['get_family_construct_data']['adult'], 'member_type'),array_values($quote_info['get_family_construct_data']['adult'])); 

                                                                        foreach($arr_fam as $fam){
                                                                            $fam_con = $newArr[$fam];
                                                                            ...
                                                                            $child_count_det = $quote_info['get_family_construct_data']['child'];
                                                                                ...
                                                                                ?><div class="col-md-6 col-6">
                                                                                    ...
                                                                                    <div class="custom-control custom-checkbox"><input type="checkbox" name="family_construct_arr[]" class="custom-control-input" data-kid = "<?php   echo $fam_con['is_adult'];?>"data-id="<?php echo $fam_con['id'];?>" id="customfrid<?php echo $fam_con['id'];?>"  disabled="true" checked value = "<?php echo $fam_con['member_type'];?>" ><label class="custom-control-label" for="customfrid<?php echo $fam_con['id'];?>"><span><?php echo $fam_con['member_type'];?></span></label></div>
                                                                   ...
                                                                   <!-- <p class="ml-tittle mt-3 age_title" style="">Enter age of the eldest member</p>
                                                                    <div class="row">
                                                                        <div class="form-group col-md-12"> <input class="form-control" type="text" maxlength="3" name="max_age" id="max_age" autocomplete="off" value ="<?php echo $quote_info['max_age'];?>" <?php if($quote_info['payment_first']==1 ){echo 'disabled';}?>> </div>
                                                                    </div>-->
                                                                    <?php
                                                                    if($total_sumInsuredCount == 1){ ?>
                                                                    <?php
                                                                    ...
                                                                    if($exist == 1) {
                                                                        ...
                                                                        <?php if(!empty($quote_info['deductable_array'])) { ?>
                                <p class="ml-tittle mt-3" > Select Deductible </p >
                                <div class="form-group dropdown_product_m_t_b_p">
                                    <select name="deductable_amount" id="deductable_amount_<?php echo $k;?>" class="form-control-age">
                                            <option value="">- Select -</option>
                                            <?php
                                            foreach($quote_info['deductable_array'] as $ded){
                                                if(!empty($quote_info['deductable']) && $quote_info['deductable']==$ded)
                                                {
                                                    $selected = 'selected';
                                                }
                                                else if($ded == $quote_info['deductable_array'][0]) {
                                                    $selected = 'selected';
                                                }else{
                                                   $selected = ''; 
                                                }
                                                ?>
                                                <option value="<?php echo $ded;?>" <?php echo $selected;?> ><?php echo $ded;?></option>
                                                <?php
                                            }
                                            ?>
                                        ...
                                        <label class="over_border_txt_proposal_add">Deductible <span style="color:#080808">*</span></label>
                                                                        ...
                                                                        <div class="form-group dropdown_product_m_t_b_p">
                                                                            ...
                                                                            <?php   }else{ ?>
                                                                                <select name="sum_insured" id="sum_insured_<?php echo $k;?>" class="form-control-age">
                                                                                    <option value="">- Select -</option>
                                                                                    <?php
                                                                                    foreach($resl as $key=>$valSum){
                                                                                        if(!empty($quote_info['cover']) && $quote_info['cover']==$valSum)
                                                                                        {
                                                                                            $selected = 'selected';
                                                                                        }
                                                                                        else if(count($resl) <=1)
                                                                                        {
                                                                                            $selected = 'selected';
                                                                                        }
                                                                                        else {
                                                                    ...
                                                                    <div class="form-group dropdown_product_m_t_b_p">
                                                                        ...
                                                                        if($quote_info['basis_details'][$pol_id]==5){
                                                                            ...
                                                                            <select name="sum_insured" id = "sum_insured_<?php echo $k;?>"class="form-control-age">
                                                                                ...
                                                                                <?php
                                                                                if($quote_info['lead_details']['is_mailer_api']==1){
                                                                                    rsort($policy_val['sumInsured']);
                                                                                }
                                                                                foreach( $policy_val['sumInsured'] as $val_r)
                                                                                {
                                                                                    if(!empty($quote_info['cover']) && $quote_info['cover']==$val_r['sum_insured'])
                                                                                        {
                                                                                            $selected = 'selected';
                                                                                        }
                                                                                    else if(count($policy_val['sumInsured']) <= 1)
                                                                                    {
                                                                                        $selected = 'selected';
                                                                                    }
                                                                                    else {
                                                                        ...
                                                                        <div class="form-group dropdown_product_m_t_b_p">
                                                                            <?php if($quote_info['basis_details'][$pol_id]==5){
                                                                                ...
                                                                                <select name="sum_insured" id = "sum_insured_<?php echo $k;?>"class="form-control-age">
                                                                                    ...
                                                                                    foreach( $policy_val['sumInsured'] as $key=>$val_r)
                                                                                    {
                                                                                        if(!empty($quote_info['cover']) && $quote_info['cover']==$val_r['sum_insured'])
                                                                                        {
                                                                                            $selected = 'selected';
                                ...
                                <div class="form-group dropdown_product_m_t_b_p">
                                    ...
                                    <?php }?>
                                                                            ...
                                                                            <div class="form-group dropdown_product_m_t_b_p">
                                                                                ...
                                                                                <label class="over_border_txt_proposal_add">Sum Insured <span style="color:#080808">*</span></label>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                            <?php
                                                                ...
                                                                <?php    }
                                                                    ?>
                                                                            ...
                                                                            <button type="button" class="btn btn-submit familyFloatBtn" style="float: right">Submit <i class="ti-check"></i></button>
                                                                            </div>
                        ...
                        <?php if($quote_info['payment_first']==1 && $quote_info['payment_page']==1) { ?>
                        <ul class=" list-item" style="margin-top: 2.5rem  !important;">
                            <li class="margin_top_li_check_i" style="margin:0 !important; ">
                    ...
                    <?php }?>
                        <div class="generate-footer text-center">
                            <?php if($quote_info['lead_details']['is_mailer_api']!=1){ ?>

                                <a href="/quotes?lead_id=<?php echo $_REQUEST['lead_id']?>" class="btn back-btn">Back</a>
                ...
                <div class="card login-card" style="background:#fff; border-radius: 30px;padding-bottom: 0px;">
                    <div class="card-body" >
                        ...
                        <div class="tl-hpage">
                            ...
                            if(isset($_SESSION['linkUI_configuaration']) && (!empty($_SESSION['linkUI_configuaration'][0]['quote_right_text']))){ ?>
                                <div class="tl-nme"><?php echo $this->session->userdata('linkUI_configuaration')[0]['quote_right_text'];?>
                                </div>
                                <?php
                            }else{ ?>
                                <?php $count=count($quote_info['policy_details']);?>
                                <div class="tl-nme">Benefits of <?php echo $count ?> plans Specially for You</div>
                    ...
                    <div>
                        ...
                        if(isset($_SESSION['linkUI_configuaration'])){
                            $image= $this->session->userdata('linkUI_configuaration')[0]['generate_quote_image'];
                            ?>
                            ...
                            <img src="/assets/abc/images/family_new.png" >
                        <?php  }
                        ?>

                    </div>
                    <?php foreach($quote_info['policy_details'] as $val_quote){
                                $polName = $val_quote['self']['sub_type_name'];
                        $polName =  $plan_exp[1];;
                                ?>
                                <p class="tl-pname" style=""><i class="fa fa-check mr-2" style="color: #0cc50c;"></i><span style="border-bottom: 1px solid grey;"><?php echo $polName; ?></span></p>
                                <?php
                        ...
                        <div>
                            ...
                            <?php
                            if(count($features) > 0) {
                                foreach ($features as $arrFeature) { ?>

<!--                                    <li class="mt-1"> <i class="fa fa-check "></i> <span>--><?php //echo strip_tags($arrFeature['long_description']); ?><!-- -  --><?php //echo $arrFeature['short_description']; ?><!--</span></li>-->
                                    <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i><?php echo strip_tags($arrFeature['long_description']); ?> <?php echo !(empty($arrFeature['short_description'])) ?  ' - '.$arrFeature['short_description']:''; ?></p>


                                <?php }
                            }else{ ?>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i>Inpatient Hospitalization covered</p>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i>527-day care procedures covered</p>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i> Organ Donor expenses covered.</p>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i>Pre & post hospitalisation cover.</p>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i>Ambulance charges covered.</p>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i>Initial 30 Days waiting period except Claims related to Accident.</p>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i>2 years waiting periods for specified illness.</p>
                                <p class="tl-pname1"><i class="fa fa-long-arrow-right mr-2" style="color: #0cc50c;"></i> Waiting period of 3 years for pre-existing diseases.</p>
...
<!-- main content area end -->
        <!-- Member Details -->
        <div class="modal fade" id="editdetails-member" style="display: none; padding-right: 16px;"  data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog  modal-dialog-centered"  role="document" style="max-width:800px">
                <div class="modal-content login-card" style="padding-bottom:0px !important;">
                    <div class="modal-header">
                        <h5 class="modal-title head-tittle" style="margin:0 !important;"><span><?php echo $plan_exp[1];?></span></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <p class="ml-tittle">Select Family Contsruct</p>
                            ...
                            <?php
                            $prod_gender = $quote_info['policy_details'][0]['product_gender'];
                            $sel_con_count = array_count_values($arr_fam);
                            $son_count = !empty($sel_con_count['Son'])?$sel_con_count['Son']:0;
                            $daughter_count = !empty($sel_con_count['Daughter'])?$sel_con_count['Daughter']:0;
                            $total_kids = $daughter_count+$son_count;
                            $i =1;
                            //print_r($quote_info['get_family_construct_data']);exit;
                            //                var_dump($arr_fam);
                            $j=1;
                            $min_max_age = [];
                            $dob_limit_array=[];
                            $dob_json=[];
                            foreach($quote_info['get_family_construct_data_all'] as $fam_con_all)
                            {//print_r($fam_con_all);

                                if(!empty($fam_con_all['member_min_age_days'])){
                                    $end_date=date('Y-m-d',  strtotime('-'.$fam_con_all['member_min_age_days'].' days'));
                                }else{
                                    $end_date =date('Y-m-d',  strtotime('-'.$fam_con_all['member_min_age'].' year'));
                                }
                                $start_date = date('Y-m-d',  strtotime('-'.$fam_con_all['member_max_age'].' year'));
                                $array_value['max_date']=$end_date;
                                $array_value['min_date']=$start_date;
                                $dob_limit_array[$fam_con_all['id']]=$array_value;

                                if($fam_con_all['is_adult'] == 'Y')
                                {
                                     $min_max_age['adult'][$fam_con_all['id']]['min_age'] = $fam_con_all['member_min_age'];
                                    $min_max_age['adult'][$fam_con_all['id']]['max_age'] = $fam_con_all['member_max_age'];
                                ...
                                {
                                    $min_max_age['child']['max_age'] = $fam_con_all['member_max_age'];
                                    $min_max_age['child']['min_age'] = $fam_con_all['member_min_age'];

                                    $min_max_age['child']['min_age_days'] = $fam_con_all['member_min_age_days'];
                            ...
                            ?><div class="col-md-9 mb-2 row">
                                ...
                                $disabled = '';
                                $dob = '';
                                if($fam_con['member_type'] =='Self' && $quote_info['self_mandatory']==1){
                                    $checked = 'checked';
                                    $disabled = 'disabled="true"';
                                }
                                
                                $min_age = $min_max_age['adult'][$fam_con['id']]['min_age'];
                                $max_age = $min_max_age['adult'][$fam_con['id']]['max_age'];
                                $min_age_child = '';
                                if(in_array($fam_con['member_type'],$arr_fam))
                                {
                                   $dob = $arr_members[$fam_con['id']]['dob'];
...
//print_r($arr_members);                                  ?>
                                <div class="col-md-3 mb-2">
                                    <div class="custom-control custom-checkbox"><input type="checkbox" name="rel_name[<?php echo $fam_con['id'];?>][id]" class="custom-control-input" data-kid = "<?php   echo $fam_con['is_adult'];?>" onclick="handleClick(this);" data-id="<?php echo $fam_con['id'];?>" id="customfrid<?php echo $fam_con['id'];?>" <?php echo $checked;?> value = "<?php echo $fam_con['member_type'];?>" <?php echo $disabled;?>><label class="custom-control-label" for="customfrid<?php echo $fam_con['id'];?>"><span><?php echo $fam_con['member_type'];?></span></label></div>
                                </div>
                                    <div class="col-md-9 mb-2" style="padding:0 30px !important;">
                                    <div class="row customfrid<?php echo $fam_con['id'];?>" style ="margin-top: -10px;display:<?php if($fam_con['id']){ echo 'block';}else{echo 'none';}?>">
                                     <label class="col-form-label">Date of Birth<span style="color:#FF0000">*</span></label> <input class="form-control datepicker1 customfrid<?php echo $fam_con['id'];?>"  onkeydown = "return false;"  inputmode="none" onclick="handleClickdate(this);" max-age = "<?php echo $max_age;?>"  min-age="<?php echo $min_age;?>"  min-age-child = "" data-det="<?php echo $fam_con['id'];?>"autocomplete="off" type="text" id="date_birth_<?php echo $fam_con['id'];?>" name="rel_name[<?php echo $fam_con['id'];?>][datebirth]" value ="<?php  echo (!empty($dob)) ? $dob : '';?>" placeholder="DD-MM-YYYY"><input type="hidden"  name ="rel_name[<?php echo $fam_con['id'];?>][member_type]" value = "A"><input type="hidden"  name ="rel_name[<?php echo $fam_con['id'];?>][rel]" value = "<?php echo $fam_con['id'];?>"></div> </div>
                                    ...
                                    ?>
                                <div class="col-md-3 mb-2">
                                    <div class="custom-control custom-checkbox"><input type="checkbox" name="rel_name[<?php echo $fam_con['id'];?>][id]" class="custom-control-input"  <?php echo $checked;?> data-kid = "<?php   echo $fam_con['is_adult'];?>" data-id="<?php echo $fam_con['id'];?>"  onclick="handleClick(this);" id="customfrid<?php echo $fam_con['id'];?>" value = "<?php echo $fam_con['member_type'];?>" <?php echo $disabled;?>><label class="custom-control-label" for="customfrid<?php echo $fam_con['id'];?>"><span><?php echo $fam_con['member_type'];?></span></label></div>
                                </div>
                                <div class="col-md-9 mb-2" style="padding:0 30px !important;">
                                    <div class="row customfrid<?php echo $fam_con['id'];?>" style =" margin-top: -10px; display:<?php if(!empty($checked)){ echo 'block';}else{echo 'none';}?>">
                            ...
                            for($i=1;$i<=$child_count_det;$i++)
                            {
                                ...
                                if($i<=$total_kids){
                                    $chked = 'checked';
                                    $dob = $arr_members[$member_type]['dob'];
                                   // $arr_members[$member_type]['member_id'];


                                }
                                //$arr_members[5];
                                $max_age = $min_max_age['child']['max_age'];
                                $min_age = $min_max_age['child']['min_age'];

                                if( $min_max_age['child']['min_age_days'])
                                {
                                    $min_age_child = $min_max_age['child']['min_age_days']."d";
                                }
                                else{
                                    $min_age_child = '';
                                }
                                ...
                                <div class="col-md-9 mb-2">
                                    ...
                                    <div class="custom-control custom-checkbox"><input type="checkbox" onclick="handleClick(this);" name="rel_name[<?php echo $member_type;?>][id]"  <?php echo $chked;?> class="custom-control-input" data-kid = "N" data-id="<?php echo $member_type;?>" id="customfrid_<?php echo $member_type;?>" value = "<?php echo $member_type;?>"><label class="custom-control-label" for="customfrid_<?php echo $member_type;?>"><span><?php echo $member_type;?></span></label></div>

                                    <div class="row customfrid_<?php echo $member_type;?>" style ="display:<?php if(!empty($chked)){ echo 'block';}else{echo 'none';}?>">
                                        <div class="mb-2 col-md-12 row "><div class="col-md-6"><div class="form-group"><label class="col-form-label">Relation With Proposer<span style="color:#FF0000">*</span></label> <select class="form-control valid kid_dob" name="rel_name[<?php echo $member_type;?>][rel]" id="<?php echo $member_type;?>_rel" aria-invalid="false"><option data-opt="" value="">Select Relation</option>
                                            <?php if((!empty($prod_gender) && $prod_gender=='M') || empty($prod_gender) || $prod_gender=='B'){ ?>
                                                <option data-opt="5" value="5" <?php   if($arr_members[$member_type]['member_id'] == 'Son') { echo 'selected';}?>>Son</option>

                                            <?php } ?>
                                            <?php if((!empty($prod_gender) && $prod_gender=='F') || empty($prod_gender) || $prod_gender=='B'){ ?>
                                                <option data-opt="6" value="6" <?php if($arr_members[$member_type]['member_id'] == 'Daughter') { echo 'selected';}?>>Daughter</option>
                                           
                                            <?php } ?>   
                                            
                                        </select> </div> </div> <div class="col-md-6"> <label class="col-form-label">Date of Birth<span style="color:#FF0000">*</span></label> <input class="form-control kid_dob_input customfrid_<?php echo $member_type;?>  datepicker1"  onkeydown = "return false;"  inputmode="none"  max-age = "<?php echo $max_age;?>"  min-age="<?php echo $min_age;?>"  min-age-child = "<?php echo $min_age_child;?>" data-det="<?php echo $member_type;?>"  autocomplete="off" type="text" id="<?php echo $member_type;?>_date_birth" name="rel_name[<?php echo $member_type;?>][datebirth]" value = "<?php echo $dob;?>" placeholder="DD-MM-YYYY"><input type="hidden"  name ="rel_name[<?php echo $member_type;?>][member_type]" value = "N"></div> </div>
                    ...
                    <div class="modal-footer" style="margin:0 !important; border-top-left-radius:0 !important; border-top-right-radius:0 !important; ">
                        <button type="button" class="btn btn-submit" id ="member_details">Submit <i class="ti-check"></i></button>
                    </div>
            ...
            <div class="modal fade" id="editdetails-float" style="display: none; padding-right: 16px; padding-left: 0px;" aria-modal="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content login-card">
                        ...
                        <div class="modal-body editDetil_Formbody">
                    ...
                    <?php
                        ...
                        <?php
                            ...
                            <!--<p class="ml-tittle mt-3 age_title" style="">Enter age of the eldest member</p>
                <div class="row">
                    <div class="form-group col-md-12"> <input class="form-control" type="text" maxlength="3" name="max_age" id="max_age" autocomplete="off" value ="<?php /*echo $quote_info['max_age'];*/?>"> </div>
                </div>
-->
                            ...
                            <div class="borderBottm"></div>
                            <div class="custom-control custom-checkbox"><div>
                                    <input type="checkbox"  name = "chk_status[]"  checked  data-flag = "1" id= "checkbox_<?php echo $k;?>"  class="custom-control-input clickcheck" value="<?php echo $policy_val['policy_id']; ?>">
                                    <label for="checkbox_<?php echo $k;?>" class=" custom-control-label" style="position: absolute; left: 3px; top: 5px;">  </label> <p class="ml-tittle mt-3" style="margin-left: 12px;"><?php echo $policy_val['policy_sub_type_name'];?></p></div></div>
                            <p class="ml-tittle mt-3" > Select Sum Insured </p >
                            <div class="form-group dropdown_product_m_t_b_p">
                                <?php
                                ...
                                if($quote_info['basis_details'][$pol_id]==5){
                                    ...
                                    <select name="sum_insured" id = "sum_insured_<?php echo $k;?>"class="form-control-age">
                                        ...
                                        foreach( $policy_val['sumInsured'] as $val_r)
                                        {
                                            ...
                                            else if((count($policy_val['sumInsured']) <= 1) || $policy_val['self']['cover']==$val_r['sum_insured'])
                                            {
                                                $selected = 'selected';
                                            }
                                            else {
                                ...
                                <div class="form-group dropdown_product_m_t_b_p">
                                    <?php if($quote_info['basis_details'][$pol_id]==5){
                                        ...
                                        <select name="sum_insured" id = "sum_insured_<?php echo $k;?>"class="form-control-age">
                                            ...
                                            foreach( $policy_val['sumInsured'] as $val_r)
                                            {
                                                if(count($policy_val['sumInsured']) <= 1 || $policy_val['self']['cover']==$val_r['sum_insured'])
                                                {
                                                    $selected = 'selected';
                                                }
                                                else {
        ...
        ?>
            ...
            <form action="<?php echo base_url() . "quotes/generate_proposal?lead_id=".$_REQUEST['lead_id'] ?>" id="hiddenQuoteForm" method="POST">
            ...
            <input id="prem_info" type="hidden" name="prem_info" value="<?php echo $policy_id_imp; ?>">
            <script>

                var mandatory_array = JSON.parse('<?php echo json_encode($mandatory_array); ?>');
                var modalonload = '<?php echo $modalonload;?>';
                
                
                if(modalonload=='1'){
                    $(window).load(function()
                    {
                        $('#editdetails-member').modal('show');
                    });
                    
                }

                $("body").on("change", '#sum_insured_1', function(e) {
                    e.preventDefault();
                    var count_policy = '<?php echo count($quote_info['policy_details']);?>';
                    if(count_policy<=1){
                        $(".familyFloatBtn").trigger("click");
                    }
                   

                });

                $("body").on("change", '#deductable_amount_1', function(e) {
                    e.preventDefault();
                    var count_policy = '<?php echo count($quote_info['policy_details']);?>';
                    if($('#deductable_amount_1').val()== 0 || $('#deductable_amount_1').val() == ""){
                        ...
                        if(count_policy<=1){
                            $.ajax({
                                url: "/quotes/Update_deductable",
                                type: "POST",
                                async: false,
                                data:{"deductable":$('#deductable_amount_1').val()},
                                dataType: "json",
                ...
                $("body").on("click", "#member_details", function() {
                    var itemForm = document.getElementById('submit_member_data'); // getting the parent container of all the checkbox inputs
                    var checkBoxes = itemForm.querySelectorAll('input[type="checkbox"]');
                    var check = itemForm.querySelectorAll('input[type="checkbox"]').checked;
                    let error = true;
                    let dob_err = true;
                    var self_mandatory = '<?php echo $quote_info['self_mandatory']?>';
debugger;
var arr = [];
var count = 0;
var kid_rel;
...
var kid_rel_len;
                    checkBoxes.forEach(item => { // loop all the checkbox item
                        if (item.checked) {  //if the check box is checked
                            ...
                            var id = item.id;
                            var data_id = item.attributes['data-id'].value;
                            var dob = $('.' + id).closest('input').val();
                            kid_rel_len = $('#' + data_id + '_rel').length;


                            if (kid_rel_len != 0){
                                kid_rel = $('#' + data_id + '_rel').val();
                                if (kid_rel == '' || kid_rel == undefined) {
                                    kid_err = false;
                                }
                        }
                    ...
                    if(self_mandatory == 1) {
                        //console.log(arr.includes('Self'));
                        if (!arr.includes('Self')) {
                            swal("Alert", "Self is Mandatory", "warning");
                            return false;
                        }
                    }

                    if (dob_err == false) {
                        swal("Alert","Please select Date Of Birth", "warning");

                        return false;
                    }
                    if (kid_err == false) {
                        swal("Alert","Please select Relation with Proposer", "warning");
                    ...
                    if (count >max_insured_count && max_insured_count>0)
                    {
                        swal("Alert","Please select only "+max_insured_count+" insured member", "warning");
                        return false;
                    }

                    var form = $("#submit_member_data").serialize();
                    $.post("/quotes/Submitmember_data", form, function (e) {
                     if(e == 1)
                     {
                ...
                $("body").on("click", '.familyFloatBtn', function(e) {
                    ...
                    if ($('input[name="family_construct_arr[]"]:checked').length >max_insured_count && max_insured_count>0)
                    { 
                        swal("Alert","Please select only "+max_insured_count+" insured member", "warning");
                        return false;
                    }
                    ...
                    $('input[name="chk_status[]"]:checked').each(function(row) {
                        ...
                        var chk_no=ids.replace ( /[^\d.]/g, '' );
                        if(($('#sum_insured_'+chk_no).val()) == 0 || $('#sum_insured_'+chk_no).val() == "")
                        {
                        ...
                        var deduct = '<?php echo !empty($quote_info['deductable_array'])? '1':'0';?>';
                        if(deduct=='1'){
                           if(($('#deductable_amount_'+chk_no).val()) == 0 || $('#deductable_amount_'+chk_no).val() == "")
                            {
                        ...
                        var sum_insured = $('#sum_insured_' + chk_no).val();
                        var deductable_a = $('#deductable_amount_' + chk_no).val();
                        if (allowSubmit) {

                            TableData[row] = {
                                "policy_id": policy_id,
                                "max_age": max_age,
                                "deductable":deductable_a,
                                "plan_id": plan_id,
...
// return;
                                ...
                                if (res.status == 200) {
                                    ...
                                    var premium = [];
                                    var premium1 = '';
                                    //  console.log(res.policy_det.length);
                                    $('.cover_det').remove();
                                    $('.sum-delNew').html('Sum Insured</br>');
                                    for (i = 0; i < res.policy_det.length; i++) {
                                        ...
                                        if (res.policy_det[i]['sub_type_name'] != '' || res.policy_det[i]['sub_type_name'] != undefined) {
                                            cover_detNew += res.policy_det[i]['sub_type_name'] + " - " + res.policy_det[i]['sum_insured'] + "<br>";
                                            cover_detNew1 = res.policy_det[i]['sub_type_name'] + " - " + res.policy_det[i]['sum_insured'];
                                            premium1 = res.policy_det[i]['policy_id'] + " - " + res.policy_det[i]['premium'];
                                            sumIn[i] = cover_detNew1;
                                            premium[i] = premium1;
                                        }
                                        ...
                                        $('.sum-delNew').append('<span class="amt-del cover_det coverNew">'+cover_detNew1+'</span><br>');
                                        $('.deductable_new').html(res.policy_det[i]['deductable']);

                                    }
// console.log(premium);return;
                                    var    premiumT= premium.join(',');
                                    //  console.log(premiumT);
                                    $('#prem_info').val(premiumT);
                                    abc.join(',');
                                    sumIn.join(',');
                                    $('#hiddenpolicyid').val(abc);
                                    $('#hiddencover').val('');
                                    $('#hiddencover').val(sumIn);
                                    swal("Alert", "Quote Updated", "success");
                                    return;
                                } else {
                ...
                $(document).on("click", ".quoteBtn", function() {
                        ...
                        var payment_first = '<?php echo $quote_info['payment_first'];?>';
                        var payment_page = '<?php echo $quote_info['payment_page'];?>';
                        
                        if (payment_first=='1' && payment_page=='1' && !$('#declare').is(':checked')) {
                  ...
                  //  if($('#customCheck').prop('checked') == true){
                    ...
                    if (allowSubmit) {
                        ...
                        if(payment_first == '1' && payment_page=='1' ){
                ...
                $('.clickcheck').change(function() {
                   var checked_policy_id=$(this).val();
                    if(this.checked) {
                        $.each(mandatory_array, function (key,val) {
                            if(key == checked_policy_id){
                                $.each(val, function (key, valnew) {
                                    $(".clickcheck[value="+valnew+"]").prop("checked","true");
                                    $(".clickcheck[value="+valnew+"]").attr("disabled", false);
                                });
                            }
                        });
                    }else{
                        $.each(mandatory_array, function (key,val) {
                            if(key == checked_policy_id){
                                $.each(val, function (key, valnew) {
                                    $(".clickcheck[value="+valnew+"]").prop("checked","true");
                                    $(".clickcheck[value="+valnew+"]").attr("disabled", true);
                                });
                            }
                        });
                    }
                ...
                /*$(document).ready(function() {
                    $(".datepicker1").datepicker({
                        ...
                        onChangeMonthYear: function(year, month, inst) {
                            debugger;
                            var min_age = '';
                            var max_age = $(this).attr('max-age');
                            var id = $(this).attr('id');
                            var min_age_child = $(this).attr('min-age-child');
                            var min_age = $(this).attr('min-age');
                            if(min_age_child !='')
                            {
                                min_age = min_age_child;
...
var newYear = inst.currentYear;

                            $('.datepicker1').datepicker('option', 'yearRange', (newYear-65) + ':' + (newYear - 18));
                ...
                function handleClick(cb) {
                    var row = cb.attributes['id'].value;
                    debugger;
                    if(cb.checked){
                ...
                $('.kid_dob_input').datepicker({ dateFormat: 'dd-mm-yy',
                    prevText: '<i class="fa fa-angle-left"></i>',
                    nextText: '<i class="fa fa-angle-right"></i>',
                    changeMonth: true,
                    yearRange:"-100:+00",
                ...
                if(Object.keys(dob_json).length>0){
                    if(dob_json.hasOwnProperty(5)){
                       $('.kid_dob_input').datepicker('option', 'minDate', new Date(dob_json[5]['min_date']));
                       $('.kid_dob_input').datepicker('option', 'maxDate', new Date(dob_json[5]['max_date']));     
                    }else if(dob_json.hasOwnProperty(6)){
                       $('.kid_dob_input').datepicker('option', 'minDate', new Date(dob_json[6]['min_date']));
                       $('.kid_dob_input').datepicker('option', 'maxDate', new Date(dob_json[6]['max_date']));     
                    }
                }
                
                $("body").on("change", ".kid_dob", function() {
                    var kid_type = $(this).val();

                    $(this).closest('.row').find('.kid_dob_input').val('');
                    $(this).closest('.row').find('.kid_dob_input').datepicker('option', 'minDate', new Date(dob_json[kid_type]['min_date']));
                    $(this).closest('.row').find('.kid_dob_input').datepicker('option', 'maxDate', new Date(dob_json[kid_type]['max_date']));
                });

                function handleClickdate(e1)
                {debugger;

                    if(Object.keys(dob_json).length>0){
                        var id = e1.attributes['id'].value;
                        var rel = $("#"+id).data('det');
                        ...
                        $('#' + id).datepicker('option', 'minDate', new Date(dob_json[rel]['min_date']));
                        $('#' + id).datepicker('option', 'maxDate', new Date(dob_json[rel]['max_date']));
                    }
                    /*var min_age = '';
                    var max_age = e1.attributes['max-age'].value;
                    var id = e1.attributes['id'].value;
                    var min_age_child = e1.attributes['min-age-child'].value;
                    var min_age = e1.attributes['min-age'].value;
                    let maxDate = '';
                    let minDates = '';
                    let mindate = '';
                    var month;
                    ...
                    var d = new Date();
                    var newYear_max = new Date().getFullYear() - max_age;
                    var newYear_min = new Date().getFullYear() - min_age;
                    $("#"+id).datepicker('option', 'yearRange', (newYear_max) + ':' + (newYear_min));
                    $("#"+id).datepicker('option', 'defaultDate',d.getDate()+'-'+  d.getMonth() +'-' + newYear_max);
                    if(min_age_child !='')
                    {
                        min_age = min_age_child;
                        $("#"+id).datepicker("option", "maxDate", '-91d');
