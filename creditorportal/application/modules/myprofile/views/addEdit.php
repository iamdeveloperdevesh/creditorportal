				...
				<div class="row">
					<div class="col-md-3 mb-3">
						...
						<div class="input-group">
							<input class="form-control" placeholder="Enter First Name" name="employee_fname" id="employee_fname" type="text" value="<?php if(!empty($user_details['employee_fname'])){echo $user_details['employee_fname'];}?>" aria-describedby="inputGroupPrepend" oninput="validateFirstName()"/>
					...
					<div class="col-md-3 mb-3">
						...
						<div class="input-group">
							<input class="form-control" placeholder="Enter Middle Name" name="employee_mname" id="employee_mname" type="text" value="<?php if(!empty($user_details['employee_mname'])){echo $user_details['employee_mname'];}?>" aria-describedby="inputGroupPrepend" oninput="validateMiddleName()"/>
							<div class="input-group-prepend">
								<span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">account_circle</span></span>
							</div>
						</div>
					...
					<div class="col-md-3 mb-3">
						...
						<div class="input-group">
							<input class="form-control" placeholder="Enter Last Name" name="employee_lname" id="employee_lname" type="text" value="<?php if(!empty($user_details['employee_lname'])){echo $user_details['employee_lname'];}?>" aria-describedby="inputGroupPrepend" oninput="validateLastName()"/>
							<div class="input-group-prepend">
					...
					<div class="col-md-3 mb-3">
						...
						<div class="input-group">
							<input class="form-control" placeholder="Enter Employee ID" name="employee_code" id="employee_code" type="text" value="<?php if(!empty($user_details['employee_code'])){echo $user_details['employee_code'];}?>" aria-describedby="inputGroupPrepend" />
							<div class="input-group-prepend">
								<span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">assignment_ind</span></span>
							</div>
						</div>
					...
					<div class="col-md-3 mb-3">
						...
						<div class="input-group">
							<input class="form-control" placeholder="Enter Email Id" name="email_id" id="email_id" type="text" value="<?php if(!empty($user_details['email_id'])){echo $user_details['email_id'];}?>" aria-describedby="inputGroupPrepend" />
							<div class="input-group-prepend">
					...
					<div class="col-md-3 mb-3">
						...
						<div class="input-group">
							<input class="form-control" placeholder="Enter Mobile No" name="mobile_number" id="mobile_number" type="text" value="<?php if(!empty($user_details['mobile_number'])){echo $user_details['mobile_number'];}?>" aria-describedby="inputGroupPrepend" />
							<div class="input-group-prepend">
					...
					<div class="col-md-3 mb-3">
						...
						<div class="input-group">
							<input class="form-control" placeholder="Enter Username" name="user_name" id="user_name" type="text" value="<?php if(!empty($user_details['user_name'])){echo $user_details['user_name'];}?>" aria-describedby="inputGroupPrepend" readonly />
							<div class="input-group-prepend">
							<span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">assignment_ind</span></span>
							</div>
						</div>
