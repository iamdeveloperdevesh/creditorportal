                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class=" form-control" name="policy_type" onchange="getPolicySubtype(this.value)">
                                            <option>Select Policy Type</option>
                                            <?php
                                            echo $datalist->details[0]->policy_type_id;
                                            foreach ($datalist->policytypes as $subtype) {
                                                ?>
                                                <option value="<?php echo $subtype->policy_type_id; ?>"
                                                    <?php if (($subtype->policy_type_id == $datalist->details[0]->policy_type_id)) echo "selected"; ?>>
                                                    <?php echo $subtype->policy_type_name; ?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">assignment_ind</span></span>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="validationCustomUsername" class="col-form-label">Select Policy Sub Type<span class="lbl-star">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="control-group form-group col-md-6 mb-3" >
                                        <label class="col-form-label" >Select Gender Specific</label>
                                        <div class="input-group">
                                            <div class="form-check custom-control custom-checkbox"> 
                                                <input type="radio" class="form-check-input custom-control-input" name="gender" value="M" id="gender_m" <?php if (($datalist->details[0]->gender == 'M')) echo "checked";?> >
                                                <label class="form-check-label custom-control-label" for="gender_m"> Male </label> 
                                            </div> 
                                            <div class="form-check custom-control custom-checkbox"> 
                                                <input type="radio" class="form-check-input custom-control-input" name="gender" value="F" id="gender_f" <?php if (($datalist->details[0]->gender == 'F')) echo "checked";?>>
                                                <label class="form-check-label custom-control-label" for="gender_f"> Female </label> 
                                            </div>
                                            <div class="form-check custom-control custom-checkbox"> 
                                                <input type="radio" class="form-check-input custom-control-input" name="gender" value="B" id="gender_b" <?php if (($datalist->details[0]->gender == 'B')) echo "checked";?>>
                                     ...
                                     <div class="control-group form-group col-md-6">
                                        ...
                                        <select class="form-control"  id="coi_type" name="coi_type">
                                            <option value="1" <?php if (($datalist->details[0]->coi_type == 1)) echo "selected"; ?>>System Generated</option>
                                            <option value="2" <?php if (($datalist->details[0]->coi_type == 2)) echo "selected"; ?>>IC Generated</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="control-group form-group col-md-4 mb-3">
                                        <div class="form-check custom-control custom-checkbox"> 
                                            <input type="checkbox" class="form-check-input custom-control-input" name="pan_mandatory" value="1" id="pan_mandatory" <?php   if($datalist->details[0]->pan_mandatory==1) echo 'checked'; ?> >
                                            <label class="form-check-label custom-control-label" for="pan_mandatory"> Is Pan Card Mandatory? </label> 
                                        </div>
                                        <div class="form-check custom-control custom-checkbox"> 
                                            <input type="checkbox" class="form-check-input custom-control-input" name="nominee_mandatory" value="1" id="nominee_mandatory" <?php   if($datalist->details[0]->nominee_mandatory==1) echo 'checked'; ?> >
                                            <label class="form-check-label custom-control-label" for="nominee_mandatory"> Is Nominee Details Mandatory? </label> 
                                        </div> 
                                    </div>


                                    <div class="control-group form-group col-md-4 mb-3" id="coi_download" <?php if (($datalist->details[0]->coi_type == 1)) echo "style='display:none'"; ?>>
                                        <div class="form-check custom-control custom-checkbox"> 
                                            <input type="checkbox" class="form-check-input custom-control-input" name="coi_download" value="1" id="coi_download_checkbox" <?php   if($datalist->details[0]->coi_download==1) echo 'checked'; ?> >
                                    ...
                                    <div class="control-group form-group col-md-4">
                                        ...
                                        <select class="form-control" id="is_single_coi" name="is_single_coi">
                                            <option value="1" <?php if (($datalist->details[0]->is_single_coi == 1)) echo "selected"; ?> >Single COI</option>
                                            <option value="0" <?php if (($datalist->details[0]->is_single_coi == 0)) echo "selected"; ?>>Proposal wise COI</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group form-group col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="coi_start_series" value="<?php echo $datalist->details[0]->coi_start_series; ?>" class="form-control" aria-describedby="inputGroupPrepend" >
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">account_circle</span></span>
                                        </div>
                                        <div class="error"><span class="planerror"></span></div>
                                ...
                                <div class="control-group form-group col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="series_digit_count" value="<?php echo $datalist->details[0]->series_digit_count; ?>" class="form-control" aria-describedby="inputGroupPrepend">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroupPrepend"><span class="material-icons">account_circle</span></span>
                                        </div>
                                        <div class="error"><span class="planerror"></span></div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    $checked='';
                                    if(($datalist->details[0]->duplicate_coi_allow) == 1){
                                        $checked='checked';
                                    }
                                    ?>
                                ...
                                <div class="control-group form-group col-md-12 table-responsive">
                                            ...
                                            if (!empty($planmodes)) {
                                                foreach ($planmodes as $key => $value) {
                                                    ...
                                                    <tr class="paymentmode_tr">
                                                        <td>
                                                            <select class="select2 form-control payment_modes" name="payment_modes[]" placeholder="Select">
                                ...
                                <div class="row">
                                    ...
                                    <div class="control-group form-group col-md-4 mb-3 payment_first">
                                        <label class="col-form-label" >Is Payment first journey? </label>
                                        <div class="input-group">
                                            <div class="form-check custom-control custom-checkbox"> 
                                                <input type="checkbox" class="form-check-input custom-control-input" name="payment_first" value="1" id="payment_first" <?php if($datalist->details[0]->payment_first==1){ echo 'checked';}?>>
                                    ...
                                    <div class="control-group form-group col-md-6 payment_page">
                                            ...
                                            <select class="form-control" id="payment_page" name="payment_page">
                                                <option value="1" <?php if($datalist->details[0]->payment_page==1){ echo 'selected';}?>>Generate quote page</option>
                                                <option value="2" <?php if($datalist->details[0]->payment_page==2){ echo 'selected';}?>>Proposer Page</option>
                                                <option value="3" <?php if($datalist->details[0]->payment_page==3){ echo 'selected';}?>>Insured Member Page</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control policyno" placeholder="Enter Policy Number" type="number" data-id="<?php echo $detail->policy_id; ?>" value="<?php if (isset($datalist->policydetails)) {
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationCustomUsername" class="col-form-label">Select Insurer</label>
