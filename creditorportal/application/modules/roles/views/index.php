			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-3 mb-3">
						<label for="validationCustomUsername" class="col-form-label">Role Name</label>
						<div class="dataTables_filter input-group" style="float:none;">
							<input id="sSearch_0" name="sSearch_0" type="text" class="searchInput form-control" placeholder="Enter role name" aria-describedby="inputGroupPrepend" >
					...
					<div class="col-md-2 col-12 txt-lr">
						...
						<a href="<?php echo base_url();?>roles"><button class="btn cnl-btn">Clear Search</button></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<?php if(in_array('RoleAdd',$this->RolePermission)){?>
						<div class="col-md-4 col-6">
							<a href="<?php echo base_url();?>roles/addEdit">
								<button class="btn btn-sec add-btn fl-right">
								<span class="partner">Add Role</span>
