            ...
            <div class="cre-head">
                <div class="row">
                    <div class="col-md-10 col-10">
                        <p>Track Claims - <i class="ti-user"></i></p>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2 col-12 text-center">
                        ...
                        <a href="<?php echo base_url();?>claim/lodgeclaims"><button class="btn cnl-btn fl-right">Clear Search</button></a>
                    </div>
                </div>
            </div>
        </div>
