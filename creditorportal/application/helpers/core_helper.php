...
function curlFunction($url, $post_fiels = null, $is_arr = false)
{
	//echo "Url: ".$url."<br/>";
...
function asyncCurlFunction($url, $post_fiels = null, $is_arr = false)
{
	//echo "Url: ".$url."<br/>";
	//echo "Curl data: <pre>";print_r($post_fiels);
	if(!$is_arr){
...
function getRolePermissions()
{
	...
	if (!empty($_SESSION["webpanel"]['role_id'])) {
		...
		//print_r(curl_init(SERVICE_URL . '/api/getLoginUserAccess'));die;
